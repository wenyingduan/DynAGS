...
from lib.add_window import Add_Window_Horizon, Add_Window_Hyper
...
def get_dataloader(args, normalizer = 'std', tod=False, dow=False, weather=False, single=True):
    ...
    #add time window
    x_hyper= Add_Window_Hyper(data_train,args.hyper_horizon,  args.hyper_stride, single)
    x_hyper = torch.cuda.FloatTensor(x_hyper)
    ...
    return x_hyper, train_dataloader, val_dataloader, test_dataloader, scaler
